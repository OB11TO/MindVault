...
modified: 2024-09-26T18:21:07+03:00
questions: 
notes: 
links: 
---
...
- **Автоочистка (VACUUM)**: PostgreSQL использует процесс **VACUUM** для очистки старых версий строк, которые больше не нужны никаким транзакциям. Когда все транзакции, которые могли бы увидеть старую версию строки, завершаются, эта старая версия становится ненужной и может быть удалена.
