...
modified: 2024-08-31T13:07:18+03:00
difficulty: easy
questions: 
notes: 
links: 
...
**Лог** – это список произошедших событий. Логгер — это объект, с помощью которого можно вести логирование.
...
Объект сохраняется в статическую переменную для удобной дальнейшей работы с ним. А также в метод `getLogger()` передается информация о классе, в котором происходит сбор информации.
...
Это новый универсальный стандарт (обертка), который позволял взаимодействовать различным логгерам вместе.

Этот логгер назвали `slf4j — Simple Logging Facade for Java`, он был оберткой вокруг `log4j`, `JUL`, `common-loggins и logback`. Этот логгер решал реальную проблему – управление различными логгерами, поэтому все стали сразу им пользоваться.
...
![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/0d264e60-385b-4611-aa8e-5a755157e5e6/b303f0af-f6e5-4350-a771-988c79b33549/Untitled.png)
